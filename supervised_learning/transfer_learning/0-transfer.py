...
MODEL_FILEPATH = "cifar10.h5"
EXTRACTED_TRAIN_DATA_PATH_BASE = "extracted_train_data.npz"
...
if __name__ == "__main__":
    ...
    if not os.path.exists(f"./{model_used}_{EXTRACTED_TRAIN_DATA_PATH_BASE}") and \
            not os.path.exists(f"./{model_used}_{EXTRACTED_TEST_DATA_PATH_BASE}"):
        ...
        np.save(f"./{model_used}_{EXTRACTED_TRAIN_DATA_PATH_BASE}", extracted_inception_feature_train)
        np.save(f"./{model_used}_{EXTRACTED_TEST_DATA_PATH_BASE}", extracted_inception_feature_train)
    else:
        extracted_inception_feature_train = np.load(f"./{model_used}_{EXTRACTED_TRAIN_DATA_PATH_BASE}")
        extracted_inception_feature_test = np.load(f"./{model_used}_{EXTRACTED_TEST_DATA_PATH_BASE}")
